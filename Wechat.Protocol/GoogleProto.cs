...
namespace Wechat.Protocol
{
    public class GoogleProto
    {
        ...
        public static BaseRequest CreateBaseRequestEntity(byte[] deviceID, string sessionKey, uint uIn, string osType)
        {
            return CreateBaseRequestEntity(deviceID, sessionKey, uIn, osType, 0);
        }

        public static BaseRequest CreateBaseRequestEntity(byte[] deviceID, string sessionKey, uint uIn, string osType, int scene)
        {
            BaseRequest.Builder brb = new BaseRequest.Builder();
        ...
        public static NewInitRequest CreateNewInitRequestEntity(uint uin, string sessionKey, string userName, byte[] deviceID, string OSType, byte[] init, byte[] max)
        {
